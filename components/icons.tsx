...
export const Icons = {
    ...
    gitHub: ({...props}: LucideProps) => (
        <svg
            ...
            data-prefix='fab'              // Data attribute, thường dùng cho FontAwesome
            data-icon='github'             // Xác định đây là icon của GitHub
        ...
        >
            <path
                ...
                // Đường dẫn (d attribute) xác định các đường nét và hình dạng tạo nên icon GitHub
    ...
    twitter: Twitter, // Sử dụng icon Twitter được nhập từ thư viện 'lucide-react'
    check: Check      // Sử dụng icon Check được nhập từ thư viện 'lucide-react'
};