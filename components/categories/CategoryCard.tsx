...
export function CategoryCard({ category, featured = false }: CategoryCardProps) {
    ...
    if (featured) {
        return (
            <Link href={category.link} className="group">
                <div className="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 group-hover:shadow-xl h-full flex flex-col">
    ...
    return (
        <Link href={category.link} className="group">
            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden transition-all duration-300 hover:shadow-md h-full flex flex-col">
