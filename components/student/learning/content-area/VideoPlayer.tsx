                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="relative flex items-center justify-center">
                            ...
                            {showQualityMenu && qualities.length > 0 && (
                                <div
                                    className="absolute bottom-full right-0 mb-2 bg-black/90 backdrop-blur-sm rounded-lg p-3 shadow-lg border border-gray-700 w-48 transform transition-all duration-200 ease-in-out animate-fade-in">
                                    <div
                                        className="text-white text-sm font-medium mb-2 pb-1 border-b border-gray-700 flex items-center">
