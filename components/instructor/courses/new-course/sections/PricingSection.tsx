    ...
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        {/* <p className="mt-2 text-sm text-gray-500">
          Giá khóa học cần phải trong khoảng từ 10.000 VNĐ (miễn phí) đến
          5.000.000 VNĐ
        </p> */}
      </div>
      {priceRealError ? (
            <p className="mt-2 text-sm text-red-600">{priceRealError}</p>
          ) : null}
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <div className="text-sm text-gray-500 mt-1">
                  Đặt giá khuyến mãi cho khóa học, giá sẽ được hiển thị cho học
                  viên dưới dạng giá cũ đã bỏ.
                  <br />
                  VD: Giá gốc fake 1.000.000 VNĐ, giá khóa học 500.000 VNĐ.
                  <br />
                  <div className="line-through  mt-2">1.000.000 VNĐ</div>
                  500.000 VNĐ
                </div>
              </div>
            </div>
