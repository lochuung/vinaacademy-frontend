...
import { ImagePlus, Video, Info, Upload, X, Image as ImageIcon, Check } from 'lucide-react';
...
export default function MediaSection({
    ...
    return (
        <div className="p-6 space-y-8">
            <InfoAlert 
                title="Hình ảnh thu hút người học" 
            ...
            {/* You can add video upload section here if needed */}
        </div>
    );
}