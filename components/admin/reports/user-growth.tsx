    ...
    const generateGrowthData = () => {
        if (timeRange === 'week') {
            ...
            return Array.from({ length: 30 }, (_, i) => ({
                ...
                get total() { return this.students + this.instructors }
            }));
                        ...
                        <CardContent>
                            ...
                            <div className="mt-4 bg-gray-50 p-4 rounded-md">
                                ...
                                <p className="text-sm text-gray-600 mb-4">
                                    Tỷ lệ giữ chân trung bình sau 8 tuần: {retentionData.reduce((sum, item) => sum + item.rate, 0) / retentionData.length}%
                                </p>
